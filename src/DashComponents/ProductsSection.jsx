...
const selectedChangeFilter = (value) => {
  ...
  if (value === "Discounted") {
    const discountedProduct = products.filter(
...
const searchUser = (e) => {
  ...
  const result = products
    .map((prod) => {
      ...
      return elementCtegories.includes(search) || elementProd.includes(search)
        ? prod
        : null;
    })
                          ...
                          <Menu.Item key={option.name}>
                            {({ active }) => (
                              <li
                                ...
                                onClick={() =>
                                  selectedChangeFilter(option.name)
                                }
                              >
                                {option.name}
                              </li>
